...
{
			customdata.fdata[0]=	fabs(Capturing_MOTO[0].getpara.round_cnt);
			customdata.fdata[1]=	Raising_MOTO[0].getpara.round_cnt;
			customdata.fdata[2]=	Chassis.mode.now;

			customdata.databit.databit.b1=cylinder_number[2];
			customdata.databit.databit.b2=cylinder_number[3];
			customdata.databit.databit.b3=cylinder_number[4];
			customdata.databit.databit.b4=cylinder_number[5];
			customdata.databit.databit.b5=Chassis.lockflag;
			customdata.databit.databit.b6=Ammo.Raising.lockheight;
